...
//
// PageEnter gives every page's content an EMERGE/SETTLE entrance, keyed
// on route -- since each institutional page renders this layout
// independently rather than sharing one persistent Next.js layout.tsx,
